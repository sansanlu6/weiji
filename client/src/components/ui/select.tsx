...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
         "focus:bg-[#EBF5EF] focus:text-[#2A483A] data-[state=checked]:bg-[#EBF5EF] data-[state=checked]:text-[#2A483A] data-[state=checked]:[&_svg:not([class*='text-'])]:text-[#5B9A76] transition-colors duration-200 relative flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8 pl-2 text-sm outline-hidden select-none data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2",
        className
      )}
