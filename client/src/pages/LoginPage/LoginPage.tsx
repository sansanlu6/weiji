...
import desktopBg from '@client/src/assets/desktop-bg.png';
...
export default function LoginPage() {
  ...
  const handleForgotPassword = () => {
    toast.info('忘记密码功能开发中，请联系管理员');
  };

  const canSubmit = username.trim() && password.trim() && agreed;
        ...
        <div className="w-full max-w-[430px] mx-auto pt-[90px] relative z-10 md:mx-0 md:ml-[10%] md:pt-0">
         ...
         >
          <div className="mb-6 pl-1">
            <h1 className="text-2xl font-bold mb-1.5 ml-[-4px]" style={{ fontFamily: 'Noto Serif SC, Source Han Serif SC, Songti SC, serif', color: '#115c29' }}>登录</h1>
            <p className="text-sm text-muted-foreground/80">登录微迹，开始记录你的生活</p>
          </div>
 ...
 style={{ color: '#126b2e' }}
            ...
            <div className="flex justify-between items-center pt-1">
               <span className="text-sm" style={{ color: '#8AA898' }}>还没有账号？</span>
               <Link to="/register" className="text-sm font-medium hover:underline" style={{ color: '#126b2e' }}>
                 立即注册
               </Link>
            </div>
          </form>
